...
{
    unsafe class GersonFrame_SelfILRuntime_AbstractMonoNormalInvoker_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GersonFrame.SelfILRuntime.AbstractMonoNormalInvoker);
        ...
        static StackObject* AddCallBack_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GersonFrame.SelfILRuntime.AbstractMonoNormalInvoker instance_of_this_method = (GersonFrame.SelfILRuntime.AbstractMonoNormalInvoker)typeof(GersonFrame.SelfILRuntime.AbstractMonoNormalInvoker).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
